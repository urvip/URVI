		...
		<nav class="navClass">
			<ul>
				...
				<li><font color="white">Payment</font>
					<ul class="sub-menu">
						<li><a href="paybooking.html"><font color="white">Booking</font></a></li>
    ...
    <div id="wrap">
        ...
        <hr/><br>
           <div class="container">
            ...
            <fieldset>
        	    <input placeholder="Violator's First Name" type="text" tabindex="2" name="firstname" required autofocus>
		    </fieldset>
            <fieldset>
                <input placeholder="Violator's Last Name" type="text" tabindex="3" name="lastname" required>
            </fieldset>
            <fieldset>
                <input placeholder="E-mail" type="email" tabindex="4" name="email" required>
            </fieldset>
            <fieldset>
                Date and Time:<input type="datetime-local" tabindex="5" name="datetime" required/>
            </fieldset>
            <fieldset>
                Location: <select tabindex="6" name="where" required/>
		    ...
		    <fieldset>
			    <textarea placeholder="Description" type="text" tabindex="7" name="description" required></textarea>
		    </fieldset>
		    <fieldset>
			    Proof: <input type="image" tabindex="8" name="proof" required>
		    </fieldset>
            <fieldset>
                <button name="btnSubmit_smoking" type="submit" id="contact-submit" data-submit="...Sending">Submit</button>
            </fieldset>
            </form>
